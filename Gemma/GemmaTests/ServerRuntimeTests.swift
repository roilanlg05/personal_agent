...
final class ServerRuntimeTests: XCTestCase {
    ...
    func testEmitsTokenAndCompleted() async throws {
        ServerRuntimeMockProtocol.responseBody = """
    ...
    func testReasoningIsNotSurfaced() async throws {
        ServerRuntimeMockProtocol.responseBody = """
        data: {"choices":[{"delta":{"reasoning":"secret thought"}}]}
    ...
    func testEmitsToolCallStarted() async throws {
        ServerRuntimeMockProtocol.responseBody = """
        data: {"choices":[{"delta":{"tool_calls":[{"index":0,"id":"abc","type":"function","function":{"name":"get_current_time","arguments":"{}"}}]}}]}
